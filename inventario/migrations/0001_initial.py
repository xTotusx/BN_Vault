# Generated by Django 5.2.11 on 2026-03-03 03:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_item', models.CharField(choices=[('CPU', 'CPU / Computadora'), ('ESCANER', 'Escáner'), ('MONITOR', 'Monitor'), ('CAJON', 'Cajón de Dinero'), ('IMPRESORA', 'Impresora (Pendiente de mapear)'), ('OTRO', 'Componente / Otro')], default='CPU', max_length=20, verbose_name='Tipo de Artículo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('guia_rastreo', models.CharField(max_length=100, unique=True, verbose_name='Guía de Paquetería o Folio Interno')),
